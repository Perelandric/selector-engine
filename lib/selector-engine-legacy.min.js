/* selector-engine | (c) 2016 Perelandric | MIT License */;(function(global) {var g=global.Query={},k=/(?:^\s+|\s+$)/g,l={},m={};g.one=function(a,b){1===arguments.length&&(b=a,a=document);var c;a:{c=new n(b);for(var f=a,d=f.getElementsByTagName(c.g),e=0,h=d.length;e<h;e+=1)if((!q||1===d[e].nodeType)&&c.matches(f,d[e])){c=d[e];break a}c=null}return c};g.all=function(a,b){1===arguments.length&&(b=a,a=document);for(var c=new n(b),f=a,d=f.getElementsByTagName(c.g),e=[],h=0,p=d.length;h<p;h+=1)q&&1!==d[h].nodeType||c.matches(f,d[h])&&e.push(d[h]);return e};
