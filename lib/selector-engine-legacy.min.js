...
return!1;case "~=":if(N(e,d.value))continue;return!1;case 21:continue;case "*=":if(-1===e.indexOf(d.value))return!1}}}return!0}function P(a,b){var c=a.charAt(b.length);return(!c||"-"===c)&&0===a.lastIndexOf(b,0)}function N(a,b){for(var c=0;-1!==(c=a.indexOf(b,c));){if(C(a,c-1)&&C(a,c+b.length))return!0;c+=b.length+1}return!1}
