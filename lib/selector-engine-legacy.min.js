...
function A(a){if(a.f)return a.f=!1,a.b;if(null===a.b)return a.b;var b=a.a+=1,c=a.c.charAt(b);a.i=a.a;if(!c||c===a.l)return a.j&&(a.j.a=a.a,a.j=null),a.b=null,a.b;switch(c){case ",":case "*":case ">":case "+":case "~":a.b=c;break;case ":":if(b=":"===a.c.charAt(a.a+1))a.a+=1;c=(v.exec(a.c.slice(a.a+1))||E)[0].toLowerCase();a.a+=c.length;"("===a.c.charAt(a.a+1)?(a.a+=1,a.b=aa(a,c)):a.b=new y(12,c,F[c]);if(!a.b||!a.b.h)switch(c){case "scope":a.b=22;break;case "first-line":case "first-letter":case "before":case "after":a.b=
25}if(b&&25!==a.b)throw u;break;case "[":b=w.exec(a.c.slice(a.a+1));if(!b)throw u;a.a+=b[0].length;a.b=new y(b[5]?24:20,b[3]?b[3].slice(1,-1):b[4],b[2]||21);a.b.name=b[1];if(b[5])if(b[2])a.b.value=a.b.value.toLowerCase();else throw u;break;default:if(b=G(a.c,a.a),0<b)a.a+=b-1,a.b=3;else if(b="#"===c?10:"."===c?18:11,11===b&&--a.a,c=v.exec(a.c.slice(a.a+1)))a.a+=c[0].length,a.b=new y(b,c[0]);else throw u;}return a.b}
