...
1)&&(this.a+=1,a=!0);b=(D.exec(this.f.slice(this.a+1))||da)[0].toLowerCase();this.a+=b.length;if(a)switch(b){case "first-line":case "first-letter":case "before":case "after":this.b=new u(12,b);this.b.c=F["no-tok"];break;default:throw t;}else if("("===this.f.charAt(this.a+1))this.a+=1,this.b=ea(this,b);else if(this.b=new u(12,b),this.b.c=F[b],!this.b.c)throw t;break;case "[":a=ba.exec(this.f.slice(this.a+1));if(!a)throw t;this.a+=a[0].length;this.b=new u(20);this.b.name=a[1];a[2]?(this.b.c=a[2],this.b.value=
a[3]?a[3].slice(1,-1):a[4]):this.b.c=21;break;case "*":this.b=B;break;default:if(b="#"===a?10:"."===a?18:11,11===b&&--this.a,a=D.exec(this.f.slice(this.a+1)))this.a+=a[0].length,this.b=new u(b,a[0]);else throw t;}return this.b};
...
function p(a){var b=a instanceof E;if(!b&&J.hasOwnProperty(a))return J[a];for(var c={},e=new E(a),d=!0,f=!1,h;h=H(e);){var n=","===h.kind;if(d){if(!h||n)throw t;d=!1;e.g=!0}h=new G(e,!0);f=f||"*"===h.qualifier;c.hasOwnProperty(h.qualifier)||(c[h.qualifier]=[]);c[h.qualifier].push(h)}e=f;this.h=[];for(var g in c)c.hasOwnProperty(g)&&(e?this.h[0]?this.h[0].push.apply(this.h[0],c[g]):this.h[0]=c[g]:this.h.push(c[g]));if(e)for(c=0,g=this.h[0];c<g.length;c+=1)g[c].qualifier="*";b||(J[a]=this)}
p.prototype.matches=function(a){for(var b=0;b<this.h.length;b+=1)if(L(a,this.h[b]))return!0;return!1};function m(a,b){for(var c=a.h.length,e=null,d=0;d<c;d+=1)M(a,b,d,function(a){e=e&&0>N(e,a)?e:a;return!0});return e}function q(a,b){for(var c=[],e=0,d=0,f=0;f<a.h.length;f+=1)M(a,b,f,function(a){for(var b=0;b<d;b+=1)if(c[b]===a)return;c.push(a)}),c.length!==d&&(e+=1,d=c.length);return e?c.sort(N):c}
function M(a,b,c,e){a=a.h[c];b=b.getElementsByTagName(O?"*":a[0].qualifier);for(c=0;c<b.length;c+=1){var d=b[c];if((!ga||1===d.nodeType)&&L(d,a)&&e(d))break}}
function G(a,b){var c=a.g?a.m:a.a+1,e=a.f.indexOf(a.u||",",c);-1===e&&(e=a.f.length);c=a.f.slice(c,e).replace(fa,"");if(K.hasOwnProperty(c))return a.g=!1,a.a=e-1,K[c];var d=!1,f;this.source=a;this.i=[];for(this.qualifier="";f=a.next();){var h=3===f.kind;h&&(f=H(a));if(f&&","!==f.kind)if(d){switch(f){case w:case x:case y:this.i.push(f);break;default:if(h)a.g=!0,this.i.push(v);else throw t;}d=!1}else{a.g=!0;d=b;P.length=0;this.qualifier="";f=H(this.source);if(!f||","===f.kind)throw t;switch(f.kind){case 11:f.value=
f.value.toUpperCase();case 1:this.qualifier=f.value||"*";P.push(f);break;default:this.source.g=!0,this.qualifier="*",d&&P.push(B)}a:for(;f=this.source.next();)switch(f.kind){case ",":case 3:case 4:this.source.g=!0;break a;case 10:case 20:case 18:case 2:case 12:P.push(f);break;default:throw t;}for(d=P.length-1;-1<d;--d)this.i.push(P[d]);P.length=0;d=!0}else{a.g=!0;break}}if(!1===d)throw t;this.i.push(z);this.source=null;e===a.a&&(K[c]=this)}var P=[];
...
function L(a,b){var c=0;a:for(;c<b.length;c+=1){for(var e=b[c],d=a,f=!1,h=-1,n=e.i.length-1;-1<n;--n){var g=e.i[n];if(4===g.kind){f=!1;switch(g.c){case 9:f=!0;break;case 5:f=!0;case 6:d=d.parentNode;break;case 7:f=!0;case 8:for(;(d=d.previousSibling)&&1!==d.nodeType;);}if(!d||1!==d.nodeType)return!1;h=n+1}else{var k,A="";switch(g.kind){case 1:continue;case 11:k=d.nodeName.toUpperCase();A=g.value;O&&"/"===k.charAt(0)&&(k=k.slice(1));if(k===A)continue;break;case 18:if(S(d.className,g.value))continue;
break;case 10:if(d.id===g.value)continue;break;case 12:if(g.c(d))continue;break;case 2:switch(g.c){case 19:if(!L(d,g.s))continue;break;case 14:if(T(d,g,"",!1))continue;break;case 15:if(T(d,g,"",!0))continue;break;case 16:if(T(d,g,A,!1))continue;break;case 17:if(T(d,g,A,!0))continue;break;case 13:for(k=d;k&&!k.lang;)k=k.parentNode;if(k&&U(k.lang,g.value))continue}break;case 20:k=d.getAttribute(g.name);if(null==k)return!1;switch(g.c){case "=":if(k===g.value)continue;break;case "^=":if(0===k.lastIndexOf(g.value,
0))continue;break;case "$=":if(k.lastIndexOf(g.value)+g.value.length===k.length)continue;break;case "|=":if(U(k,g.value))continue;break;case "~=":if(S(k,g.value))continue;break;case 21:continue;case "*=":if(-1!==k.indexOf(g.value))continue}}if(f)continue a;n=h}}return!0}return!1}function U(a,b){var c=a.charAt(b.length);return(!c||"-"===c)&&0===a.lastIndexOf(b,0)}function S(a,b){for(var c=-1;-1!==(c=a.indexOf(b,c+1));)if(ha.test(a.charAt(c-1)+a.charAt(c+b.length)))return!0;return!1}
function T(a,b,c,e){var d=b.j;b=b.l;var f=0>=d?b:Infinity;if(!a.parentNode)return!1;var h=1,n=e?a.parentNode.lastChild:a.parentNode.firstChild;for(c=c.toUpperCase();n!==a&&h<=f;)1!==n.nodeType||c&&n.nodeName.toUpperCase()!==c||(h+=1),n=e?n.previousSibling:n.nextSibling;return h===b||0<=d===h>=b&&0===(h-b)%d}var V={INPUT:1,TEXTAREA:1,SELECT:1,BUTTON:1,OPTION:1,OPTGROUP:1},W={hidden:1,image:1,button:1,submit:1,reset:1};
