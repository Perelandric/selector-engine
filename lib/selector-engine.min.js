...
;(function(global) {var k,m=global.Query={},n=/(?:^\s+|\s+$)/g,q={},r={};m.one=function(a,b){1===arguments.length&&(b=a,a=document);return t(new u(b),a)};m.all=function(a,b){1===arguments.length&&(b=a,a=document);return v(new u(b),a)};m.matches=function(a,b){return(new u(b)).matches(a)};var w=Error("Invalid selector"),y=new x(12),B=new x(4),C=new x(4),D=new x(4),E=new x(4),F=new x(4),G=new x(1),aa=new x(",",","),ba=new x(3," "),H=/^-?(?:[_a-zA-Z\u0080-\uFFFF]|\\[^\n]?|--\d?)(?:[-\w\u0080-\uFFFF]|\\[^\n]?)*/,ca=new RegExp("^\\s*("+H.source.slice(1)+")\\s*(?:([$^*~|]?=)\\s*(?:((?:'(?:[^'\\n]|\\\\\\n)*')|(?:\"(?:[^\"\\n]|\\\\\\n)*\"))|("+H.source.slice(1)+")))?\\s*([iI]?)\\s*]"),da=/^(?:([-+]?\d+)|([-+]?\d*)?n\s*(?:([-+])\s*(\d+))?|(even)|(odd))\s*\)/i;B.c=6;C.c=5;D.c=7;E.c=8;F.c=9;
y.c=25;function x(a,b){this.kind=a;this.value=b}k=x.prototype;k.kind=0;k.c=0;k.s=null;k.name="";k.value="";k.j=0;k.l=0;function I(a,b,c,d){a instanceof I?(this.f=a.f,this.a=a.a,this.o=a.o,this.u=a):(this.f=a,this.o=this.a=-1);this.A=!!c;this.w=!!d;this.v=b||"";this.g=!1;this.b=this.next();this.g=!0}var ea=[""];
...
y;break;default:throw w;}else if("("===this.f[this.a+1])this.a+=1,this.b=fa(this,a);else if(this.b=new x(12,a),this.b.c="scope"===a?22:J[a],!this.b.c)throw w;break;case "[":b=ca.exec(this.f.slice(this.a+1));if(!b)throw w;this.a+=b[0].length;this.b=new x(b[5]?24:20);this.b.name=b[1];if(b[2])this.b.c=b[2],this.b.value=b[3]?b[3].slice(1,-1):b[4],b[5]&&(this.b.value=this.b.value.toLowerCase());else if(this.b.c=21,b[5])throw w;break;case "*":this.b=G;break;default:if(b=K(this.f,this.a),0<b)this.a+=b-1,
this.b=ba;else if(b="#"===a?10:"."===a?18:11,11===b&&--this.a,a=H.exec(this.f.slice(this.a+1)))this.a+=a[0].length,this.b=new x(b,a[0]);else throw w;}return this.b};
function fa(a,b){var c=new x(2,b.toLowerCase()),d;switch(c.value){case "not":if(a.A)throw w;d=new I(a,")",!0,!1);c.s=new u(d);c.c=19;break;case "matches":d=new I(a,")",!1,!0);c.s=new u(d);c.c=23;break;case "lang":d=new I(a,")",!0,!0);c=L(d);if(11===c.kind)c.kind=2,c.c=13;else throw w;break;case "nth-child":return c.c=14,M(a,c);case "nth-last-child":return c.c=15,M(a,c);case "nth-of-type":return c.c=16,M(a,c);case "nth-last-of-type":return c.c=17,M(a,c);default:throw w;}if(d.next())throw w;return c}
function L(a){for(var b;(b=a.next())&&3===b.kind;);return b}function M(a,b){b.j=0;b.l=0;var c=da.exec(a.f.slice(a.a+1));if(!c)throw w;a.a+=c[0].length;if(c[1])b.l=+c[1];else if(c[5])b.j=2;else if(c[6])b.j=2,b.l=1;else{var d=c[2],c=c[3]+c[4];b.j=d&&"+"!==d&&"-"!==d?+d:"-"===d?-1:1;c&&(b.l=+c)}return b};function u(a){var b=a instanceof I;if(!b&&q.hasOwnProperty(a))return q[a];for(var c={},d=b?a:new I(a),f=!0,e=!1,l;l=L(d);){var z=","===l.kind;if(f){if(!l||z)throw w;f=!1;d.g=!0}l=new N(d);l.m||(e=e||"*"===l.qualifier,c.hasOwnProperty(l.qualifier)||(c[l.qualifier]=[]),c[l.qualifier].push(l))}this.h=[];for(var p in c)if(d=c[p],c.hasOwnProperty(p)&&d.length)if(e){for(f=0;f<d.length;f+=1)d[f].qualifier="*";this.h[0]?this.h[0].push.apply(this.h[0],d):this.h[0]=d}else this.h.push(d);b||(q[a]=this)}
