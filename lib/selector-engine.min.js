...
new A(12,a),this.b.c=F[a]);if(!this.b||!this.b.c)switch(a){case "scope":this.b=22;break;case "first-line":case "first-letter":case "before":case "after":this.b=25}if(b&&25!==this.b)throw v;break;case "[":b=y.exec(this.f.slice(this.a+1));if(!b)throw v;this.a+=b[0].length;this.b=new A(b[5]?24:20);this.b.name=b[1];if(b[2])this.b.c=b[2],this.b.value=b[3]?b[3].slice(1,-1):b[4],b[5]&&(this.b.value=this.b.value.toLowerCase());else if(this.b.c=21,b[5])throw v;break;case "*":this.b=1;break;default:if(b=G(this.f,
this.a),0<b)this.a+=b-1,this.b=3;else if(b="#"===a?10:"."===a?18:11,11===b&&--this.a,a=w.exec(this.f.slice(this.a+1)))this.a+=a[0].length,this.b=new A(b,a[0]);else throw v;}return this.b};
...
function N(a,b){this.B=[];delete b.qualifier;var c=H(a);if(!c||4===c)throw v;1!==c&&(11===c.kind?b.qualifier=this.tag=c.value.toUpperCase():a.g=!0);a:for(;c=a.next();){switch(c){case 4:case 3:case 5:case 7:case 8:a.g=!0;break a}if(b.v)throw v;if(25===c)b.v=!0,b.o=!0;else if(22===c)b.i&&(b.o=!0),this.i=!0;else switch(c.kind){case 12:case 10:case 20:case 24:case 18:case 2:this.B.push(c);break;default:throw v;}}this.i&&(b.i=!0)}g.tag="";g.i=!1;
